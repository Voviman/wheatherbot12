...
owm = pyowm.OWM('5edfb276a6e154e914b96ac9bf1cf2a0', language = "ru")  # You MUST provide a valid API key
...
def send_welcome(message):
	bot.reply_to(message, "Привет! чтобы узнать погоду напиши название города/страны")
